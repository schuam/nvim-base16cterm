...
local make = function(c)
    local hlgroups = {
        ...
        {hlgroup = 'None', ctermfg = 'none', ctermbg = 'none', cterm = 'none'},
        ...
        {hlgroup = 'Strikethrough', ctermfg = nil, ctermbg = nil, cterm = 'strikethrough'},
        {hlgroup = 'TooLong', ctermfg = c.base08, ctermbg = nil, cterm = nil},
        {hlgroup = 'Underlined', ctermfg = c.base0D, ctermbg = nil, cterm = 'underline'},
        ...
        {hlgroup = 'Title', ctermfg = c.base0A, ctermbg = nil, cterm = 'none'},
